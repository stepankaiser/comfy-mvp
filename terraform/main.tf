# ComfyUI Golden Image AWS Infrastructure
...
# S3 Bucket for Golden Image Storage
...
resource "aws_s3_bucket_accelerate_configuration" "models" {
  bucket = aws_s3_bucket.models.id
  status = "Enabled"
}
